function Carousel(config) {
  ...
  function init() {
    ...
    Array.prototype.forEach.call(_show, function (sh) {
      //remover classes show se houver
  ...
  function showSlide() {
    ...
    var slide = _currentSlide % qtd; //inverte e calcula o resto. INverte caso necessário
    slide = Math.abs(slide);
    // _currentSlide = Math.abs(_currentSlide)
    console.log(_currentSlide, qtd, slide);
